                ...
                <form className="needs-validation">
                    <div className="row g-3">
                        <div className="col-sm-6">
                            <label htmlFor="firstName" className="form-label">Authorization
                                (ROLE_{user?.data.user.role})</label>
                            <select defaultValue={user?.data.user.role} className="form-select"
                                    onChange={(event) => onUpdateRole({role: event.target.value})}
                            ...
                            <div className="small text-muted mt-3">Role gives permissions to control actions users are
                                allowed or disallowed to take.
                            </div>
                        </div>
                        <div className="col-sm-6">
