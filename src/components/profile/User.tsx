    ...
    return (
        <div className="container main">
            <div className="row">
                ...
                {isSuccess && <>
                    <div className="col-lg-3 col-md-5 col-sm-12">
                        <div className="card text-center mb-3">
                            <div className="card-body">
                                <img src={userData?.data.user.imageUrl} className="img-fluid mx-auto user-photo"
            ...
            <div style={{display: 'none'}}>
                <input type='file' ref={inputRef} onChange={(event) => uploadPhoto(event.target.files[0])} name='file'
                       accept='image/*'/>
            </div>
        </div>
    );
